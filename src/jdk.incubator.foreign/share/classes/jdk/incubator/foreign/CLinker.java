...
public interface CLinker {
    ...
    static String toJavaStringRestricted(MemoryAddress addr) {
        ...
        return SharedUtils.toJavaStringInternal(MemorySegmentImpl.EVERYTHING, addr.toRawLongValue(), Charset.defaultCharset());
    }
    ...
    static String toJavaStringRestricted(MemoryAddress addr, Charset charset) {
        ...
        Objects.requireNonNull(addr);
        Objects.requireNonNull(charset);
        return SharedUtils.toJavaStringInternal(MemorySegmentImpl.EVERYTHING, addr.toRawLongValue(), charset);
    }
